...
from lilypad_rag_agent.config import VECTOR_STORE_DIR, DEFAULT_EMBEDDING_MODEL
...
class VectorStore:
    ...
    def __init__(self, persist_directory=VECTOR_STORE_DIR, embedding_model=DEFAULT_EMBEDDING_MODEL):
